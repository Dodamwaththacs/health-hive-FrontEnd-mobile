...
const Signin = () => {
  ...
  const handleSignIn = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        "http://192.168.229.140:8080/realms/Health-Hive/protocol/openid-connect/token",
        body.toString(),
        {
          headers: {
  ...
  const handleForgotPassword = () => {
    const url =
      "http://192.168.229.140:8080/realms/Health-Hive/login-actions/reset-credentials";
    Linking.openURL(url);
  };
