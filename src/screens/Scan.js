...
const Scan = () => {
  ...
  const fetchUserData = async () => {
    ...
    try {
      const response = await axios.get(
        `http://192.168.190.140:33000/api/users/email/${email}`
      );
  ...
  const handleBarCodeScanned = async ({ type, data }) => {
    ...
    try {
      const response = await axios.get(
        `http://192.168.190.140:33000/api/users/${scannedUserId}`
      );
  ...
  const handleLabRequest = async () => {
    ...
    try {
      const response = await axios.post(
        "http://192.168.190.140:33000/api/labRequests",
  ...
  const handleHealthReport = async () => {
    ...
    try {
      const response = await axios.post(
        "http://192.168.190.140:33000/api/labReportShares",
  ...
  const fileUpload = async () => {
    ...
    try {
      for (let i = 0; i < selectedFiles.length; i++) {
        ...
        const response = await axios.post(
          "http://192.168.190.140:33000/api/shareFiles",
          {
