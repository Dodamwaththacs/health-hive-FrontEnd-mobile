    ...
    const fetchDataFromOringin = async () => {
      try {
        const response = await axios.get(
          "http://192.168.151.43:33000/api/files/user/2"
        );
        ...
        for (let i = 0; i < originData.length; i++) {
          ...
          try {
            ...
            try {
              await axios.delete(
                "http://192.168.151.43:33000/api/files/" + originData[i].id
              );
            } catch (error) {
            ...
            try {
              await axios.delete(
                "http://192.168.151.43:33000/api/labDataUploads/" +
            ...
            try {
              await axios.delete(
                "http://192.168.151.43:33000/api/labRequests/" +
